    ...
    <div className={divStyle}>
      ...
      <div className="flex flex-col gap-1 justify-center items-start ml-10">
        ...
        {isFullTextVisible ? (
          ...
          <p className="font-roboto text-xs ">{props.description.substring(0, 50)}...</p>
        )}
